...
class BertTagger(nn.Module):
    def __init__(self, params):
        ...
        self.type_classifier = nn.Linear(self.hidden_dim, self.num_tag)
    ...
    def forward(self, X):
        ...
        index_pred = self.index_classifier(outputs)
        type_pred = self.type_classifier(outputs)

        # return self.sigmoid(index_pred),self.sigmoid(type_pred)
